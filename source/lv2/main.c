...
#ifdef SWIZZY_THEME
    console_set_colors(CONSOLE_COLOR_BLACK,CONSOLE_COLOR_ORANGE); // purple text on white bg
#elif defined XTUDO_THEME
    console_set_colors(CONSOLE_COLOR_BLACK,CONSOLE_COLOR_PINK); // purple text on white bg
#elif defined DEFAULT_THEME
    console_set_colors(CONSOLE_COLOR_BLUE,CONSOLE_COLOR_WHITE); // purple text on white bg
#e
    console_set_colors(CONSOLE_COLOR_BLACK,CONSOLE_COLOR_GREEN); // purple text on white bg
#endif
    console_init();
